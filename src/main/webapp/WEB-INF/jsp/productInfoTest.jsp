            ...
            <div class="row ">
                <div class="col-6 row">
                    <div class="col-12 rounded mx-auto mb-2" style="max-width: 620px;">
                        <img id="mainImage" class="rounded" src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_1.png" alt="Product Image" style="width: 100%; object-fit: cover;">
                    </div>
                    <div class="d-flex align-items-center overflow-hidden" style="position: relative;">
                        ...
                        <div class="slider rounded">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_1.png" class="img-slider rounded" onmouseover="changeImage(this)">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_2.png" class="img-slider rounded" onmouseover="changeImage(this)">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_3.png" class="img-slider rounded" onmouseover="changeImage(this)">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_4.png" class="img-slider rounded" onmouseover="changeImage(this)">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_5.png" class="img-slider rounded" onmouseover="changeImage(this)">
                            <img src="https://raw.githubusercontent.com/HoanghoDev/youtube_v2/main/auto_slider/images/slider2_6.png" class="img-slider rounded" onmouseover="changeImage(this)">
                        </div>
                        <button class="slider-btn right" onclick="moveSlider(1)"><i class="bi bi-chevron-right"></i></button>
                    </div>
                </div>
                <div class="col-6 row" id="customizations">
                
                <input type="text" class="form-control-plaintext fs-3 fw-semibold" id="price" name="price" value="$9000">
                    <div class="quantity-container">
                        <div class="quantity-btn" onclick="updateQuantity(-1)"><i class="bi bi-dash-lg"></i></div>
                        <input type="text" class="quantity-input" id="quantity" name="quantity" value="1" min="1" autocomplete="off">
