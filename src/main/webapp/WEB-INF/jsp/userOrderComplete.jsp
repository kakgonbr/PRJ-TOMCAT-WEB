                        ...
                        <div class="accordion fs-6" id="menuAccordion">
                                ...
                                <div id="collapseProfile" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        <a href="${pageContext.request.contextPath}/user"
                                            class="list-group-item list-group-item-action pb-3">Profile</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOrder" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        <a href="${pageContext.request.contextPath}/userorder?action=order"
                                            class="list-group-item list-group-item-action pb-3">Order
                                        </a>
                                        <a href="${pageContext.request.contextPath}/userorder?action=complete"
                                            class="list-group-item list-group-item-action">Order
                                            completed</a>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseShop" class="accordion-collapse collapse">
                                    <a href="#"
                                        class="list-group-item list-group-item-action p-3">Notification</a>
                                </div>
                            </div>
                ...
                <main class="col-10">
                    <c:choose>
                        <c:when test="${OrderItemList != null}">
                            ...
                            <div class="card my-4">
                                <div class="card-body">
                                    <form action="${pageContext.request.contextPath}/userorder"
                                        method="post" class="row g-3 align-items-center">
                                        <input type="hidden" name="action" value="complete">
                                        <input type="hidden" name="status" value="true">
                                        <div class="col-auto">
                                            <label for="startDate" class="col-form-label">Từ
                                                ngày:</label>
                                        </div>
                                        <div class="col-auto">
                                        ...
                                        <div class="col-auto">
                                            <label for="endDate" class="col-form-label">Đến
                                                ngày:</label>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <c:if test="${message == null}">
                                <c:forEach var="orderItem" items="${OrderItemList}" varStatus="status">
                                    <c:if
                                        test="${status.index == 0 || OrderItemList[status.index-1].orderId != orderItem.orderId}">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header bg-primary text-white">
                                                <div
                                                    ...
                                                    <span>
                                                        <fmt:formatDate value="${orderItem.date}"
                                    ...
                                    <div class="row mb-3 p-3 border-bottom">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p class="text-muted mb-1">Cửa hàng:
                                                ${orderItem.productWrapper.shop.name}</p>
                                            <div class="small">
                                        ...
                                        <div class="col-2 text-center">
                                            ...
                                            <c:if test="${orderItem.productWrapper.promotion != null}">
                                                <p class="text-danger mb-1">
                                                    <c:choose>
                                                        <c:when
                                                            test="${orderItem.productWrapper.promotion.type}">
                                                            Giảm
                                                            ${orderItem.productWrapper.promotion.value}đ
                                                        </c:when>
                                                        <c:otherwise>
                                                            Giảm
                                        ...
                                        <div class="col-2 text-end">
                                            <h6>
                                                <c:choose>
                                                    <c:when
                                                        test="${orderItem.productWrapper.promotion != null && orderItem.productWrapper.promotion.type}">
                                                        ${(orderItem.productItem.price -
                                                        orderItem.productWrapper.promotion.value) *
                                                        orderItem.quantity}đ
                                                    </c:when>
                                                    <c:when
                                                        test="${orderItem.productWrapper.promotion != null && !orderItem.productWrapper.promotion.type}">
                                                        ${(orderItem.productItem.price * (100.0 -
                                                        orderItem.productWrapper.promotion.value) /
                                                        100.0) *
                                                        orderItem.quantity}đ
                                                    </c:when>
