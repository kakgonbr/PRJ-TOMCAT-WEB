<%-- POSSIBLE REQUEST ATTRIBUTES:  exceed (model.CartItemWrapper) --%>
...
<t:genericpage title="Cart">
    ...
    <jsp:attribute name="body">
        <h2>Actions required for following items:</h2>
        <table border="1">
            <tr>
                <td>Image</td>
                <td>Name</td>
        ...
        <a href="${pageContext.request.contextPath}/cart">To Cart</a>
    </jsp:attribute>
