...
public final class CartDAO {
    ...
    public static final class CartFetcher {
        ...
        private static final String GET_CART_BY_USER = "SELECT c FROM Cart c JOIN FETCH c.cartItemList ci JOIN FETCH ci.productItemId pi JOIN FETCH pi.productCustomizationList WHERE userId = :userId";
