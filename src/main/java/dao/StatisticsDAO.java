...
public final class StatisticsDAO {
    private static final String LOCK_TABLE_SERVER_STATISTICS = "SELECT * FROM tblServerStatistics FOR UPDATE";
    private static final String LOCK_TABLE_SHOP_STATISTICS = "SELECT * FROM tblShopStatistics FOR UPDATE";
    private static final String LOCK_TABLE_SHOP_STATISTICS_BY_ID = "SELECT * FROM tblShopStatistics WHERE id = ? FOR UPDATE";
    ...
    public static final class SystemStatisticsManager {
        ...
        public static synchronized void addStatistics(Connection connection) throws SQLException {
            try (Statement lockStatement = connection.createStatement()) {
                lockStatement.executeQuery(LOCK_TABLE_SERVER_STATISTICS);
        ...
        } // public static void addStatistics(Connection connection) throws java.sql.SQLException
