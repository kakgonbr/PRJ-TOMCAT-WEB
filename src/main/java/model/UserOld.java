...
public final class UserOld {
    ...
    // information only
    public UserOld(int t_id, String t_username, String t_displayName, String t_profile, String t_bio, long t_credit) {
        setId(t_id);
    ...
    // everything
    public UserOld(int t_id, String t_username, String t_displayName, String t_profile, String t_bio, long t_credit, String t_email, String t_phoneNumber, String t_password, LinkStatus t_linkStatus, int t_cartId, String t_cookie, boolean t_isAdmin) {
    ...
    public static UserOld fromResultSet(java.sql.ResultSet rs) throws java.sql.SQLException {
        return new UserOld(rs.getInt("id"),
