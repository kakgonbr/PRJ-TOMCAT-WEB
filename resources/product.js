...
function fetchProductsShop(shopId) {
    ...
    fetch(url.toString())
        ...
        .then(data => {
            ...
            tableBody.innerHTML = "<tr><th>Shop</th><th>Category</th><th>Name</th><th>Description</th><th>Actions</th></tr>";
            ...
            data.forEach(item => {
                ...
                editButton.onclick = function () {
                    window.location.href = contextPath + "/product?action=edit&productId=" + item.id;
                };
                ...
                deleteButton.onclick = function () {
                    if (confirm("Are you sure you want to delete this product?")) {
                        window.location.href = contextPath + "/product?action=delete&productId=" + item.id;
                    }
                };
